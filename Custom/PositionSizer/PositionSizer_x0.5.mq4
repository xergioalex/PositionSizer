...
input bool ShowAdditionalSLLabel = true; // ShowAdditionalSLLabel: Show SL $/% label?
input bool ShowAdditionalTPLabel = true; // ShowAdditionalTPLabel: Show TP $/% + R/R label?
input bool ShowAdditionalEntryLabel = true; // ShowAdditionalEntryLabel: Show Position Size label?
...
input uint entry_line_width = 3; // Entry Line Width
input uint stoploss_line_width = 3; // Stop-Loss Line Width
input uint takeprofit_line_width = 3; // Take-Profit Line Width
input uint be_line_width = 3; // BE Line Width
...
input bool DefaultDisableTradingWhenLinesAreHidden = true; // DisableTradingWhenLinesAreHidden: for Trading tab.
...
input bool DefaultAskForConfirmation = false; // AskForConfirmation: Ask for confirmation for Trading tab.
...
input double TP_Multiplier = 0.53; // TP Multiplier for SL value, appears in Take-profit button.
...
input double PercentageOfNegativeProfitToBreakEven = 35; // Percentage of negative profit to break even
